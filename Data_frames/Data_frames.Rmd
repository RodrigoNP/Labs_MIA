...
* Podemos extraer las observaciones de las variables con '$' 
...
* ¿Cuál es el id del hombre con promedio más alto en la carrera de Ciencia Política? Para esto, recuerda la función sort()
